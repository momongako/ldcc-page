...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2022 at 06:10 AM
...
--
-- Table structure for table `relation_posts`
--

CREATE TABLE `relation_posts` (
  `id` int(10) UNSIGNED NOT NULL,
  `post_id` int(10) UNSIGNED NOT NULL,
  `relation_post_id` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `tab_configs`
--
...
--
-- Indexes for table `relation_posts`
--
ALTER TABLE `relation_posts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `relation_posts_post_id_index` (`post_id`),
  ADD KEY `relation_posts_relation_post_id_index` (`relation_post_id`);

--
-- Indexes for table `tab_configs`
--
...
--
-- AUTO_INCREMENT for table `relation_posts`
--
ALTER TABLE `relation_posts`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tab_configs`
--
ALTER TABLE `tab_configs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
