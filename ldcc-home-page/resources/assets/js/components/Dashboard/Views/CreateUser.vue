                    ...
                    <div class="row">
                        <div class="col-xs-offset-4 form-group">
                            ...
                            <div v-if="step =='confirm' ">
                                ...
                                <button class="btn btn-success btn-update-form">Save</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        methods: {
            ...
            checkForm: function (e) {
                ...
                if (!this.customer.password) {
                    ...
                    this.messageError.push('The password field is required.');
                }
                //validate email
                if (!this.customer.email) {
                    ...
                    if (!this.validEmail(this.customer.email)) {
                        ...
                        this.messageError.push('The email must be a valid email address.');
            ...
            saveForm() {
                ...
                if(this.checkForm()){
                    axios.post('/admin/user', formData,header)
                        .then(function (resp) {
                          app.$isLoading(true)
