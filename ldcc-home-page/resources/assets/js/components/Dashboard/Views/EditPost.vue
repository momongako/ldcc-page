                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-create">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style="pointer-events: none;opacity: 0.4;cursor: not-allowed" class="form-group">
                                            <label style="color: #333333" for="thumbnail">Categories</label>
                                ...
                                <div v-show="this.showFormNewEvent()" class="row">
                                    <div class="col-md-12">
                                        <fg-input id="sub_title" type="text"
                                                label="Description"
                                ...
                                <div v-show="this.showCaseStudy()" class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input id="case_name" type="text" placeholder="Case name" class="form-control border-input"
                                               v-model="post.case_name" @keyup="slugConvert($event.target.value)">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <router-link v-if="step=='create'" to="/posts" class="btn btn-default">Cancel</router-link>
                                        </div>
                                    </div>
                                </div>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/admin/post/' + id)
                .then(function (resp) {
                    app.post = resp.data;
                    if (app.post.thumbnail !== null && app.post.thumbnail !== ''){
                      app.imagePreview = 'https://pronexus-media-files.s3-ap-southeast-1.amazonaws.com/public' + app.post.thumbnail;
                    }
        ...
        methods: {
              ...
              showFormNewEvent(){
                return this.post.category_id === 1;
              },
            getTreeCategories () {
            ...
            getCkeditor(){
                ...
                CKEDITOR.instances['content'].setData(this.post.content);

                // Job posting
                CKEDITOR.replace('job_description');
                CKEDITOR.instances['job_description'].setData(this.post.job_description);
                ...
                CKEDITOR.instances['challenges_and_needs'].setData(this.post.challenges_and_needs);

                CKEDITOR.replace('our_work',{
                customConfig: '/ckeditor/basic-config.js'
                });
                CKEDITOR.instances['our_work'].setData(this.post.our_work);

                CKEDITOR.replace('outcome',{
                customConfig: '/ckeditor/basic-config.js'
                });
                CKEDITOR.instances['outcome'].setData(this.post.outcome);
            },
          ...
          checkForm: function (e) {
            ...
            if (this.showFormNewEvent()){
              ...
              if (!this.post.type) {
                this.errors['type'] = 'Enter post type';
                this.messageError.push('Enter post content');
              }
            }
            ...
            saveForm() {
              ...
              formData.append('status', this.post.status);
                ...
                if(this.checkForm()){
                  this.$isLoading(true)
                    axios.post('/admin/edit-post/'+app.post.id, formData,header)
                        .then(function (resp) {
