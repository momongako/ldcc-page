...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            axios.get('/admin/banner/' + id)
                .then(function (resp) {
                    app.banner = resp.data;
                    app.imagePreview = app.banner.path;
                    app.image = app.banner.path;
                    if (app.imagePreview) {
        ...
        methods: {
            ...
            checkForm: function (e) {
                ...
                //validate key
                if (!this.banner.link) {
                    this.errors['link'] = 'Nhập tiêu link';
                    this.messageError.push('Nhập tiêu link');
                }
            ...
            saveForm() {
                ...
                if(this.checkForm()){
                    axios.post('/admin/edit-banner/'+app.banner.id, formData,header)
                        .then(function (resp) {
