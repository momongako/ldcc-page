        ...
        methods: {
            ...
            checkForm: function (e) {
                ...
                if (!this.category.link) {
                    this.errors['link'] = 'Enter menu link';
                    this.messageError.push('Enter menu link');
                }
            ...
            saveForm() {
                ...
                if(this.checkForm()){
                    axios.post('/admin/menu', newCategory)
                        .then(function (resp) {
                        ...
                        .catch(function (resp) {
                            app.notifyVue('danger',"Menu creation failed, please try again.");
                        });
                }
            },
