<?php //echo \App\Lib\BHelp::getConfigSetting('HOME_PAGE_CO_VAN_TIEU_BIEU')?>

<div class="container">
    <h3 class="heading-section"><?php echo \App\Lib\BHelp::getConfigSetting('HOME_CO_VAN_TIEU_BIEU')?></h3>
    <ul class="list-advisor">
        <?php foreach ($co_van_tieu_bieu as $key => $value) : ?>
            <?php if($key < 3): ?>
                <li class="wow fadeInUp" data-wow-delay="0.{{$key+1}}s">
                    <div class="member">
                        <img src="<?php echo \App\Lib\BHelp::getLinkCustom('img', '/frontend/assets/images/hex-big.svg')?>" class="pattern-hex" alt="">
