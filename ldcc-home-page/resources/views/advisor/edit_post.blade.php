        ...
        <div class="blog-header">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-10">
                        <h1>{{ __('Sửa bài viết') }}</h1>
                        <div class="card">
                            @if(session()->has('message'))
                                <p class="alert {{ session()->get('alert-class', 'alert-info') }}">{{ session()->get('message') }}</p>
                            @endif
                            <div class="card-body">
                                <form method="POST" action="/ad/cap-nhat-bai-viet/{{$post->slug}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div>
                                            <img src="<?php echo \App\Lib\BHelp::getLinkCustom('img', $post->thumbnail)?>" id = "imagePreview" width="100" height="100"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <textarea id="sub_title" class="form-control @error('sub_title') is-invalid @enderror" name="sub_title" required autocomplete="sub_title" autofocus>
                                                {{ old('sub_title')?:$post->sub_title }}
                                            </textarea>
