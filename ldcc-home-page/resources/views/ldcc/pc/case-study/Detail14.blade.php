            ...
            <div class=page-header_content>
                <div class=page-header_breadcrumbs style="color: #666666; font-size: 15px; line-height: 24px;">
                    <div class=breadcrumbs><a href=index.html class=home>Home</a> <span class=divider></span> <a
                        ...
                        <span class=current>Membership integration</span>
                    </div>
                </div>
            </div>
        </div>
...
<main id=main class=site-main>
    ...
    {{--title detai --}}
    <?php
    if(\App\Lib\BHelp::getConfigSetting('CASE_STUDY_DETAIL_14')){
        echo \App\Lib\BHelp::getConfigSetting('CASE_STUDY_DETAIL_14');
    }
    ?>
