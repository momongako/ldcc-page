        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <div
                            class=breadcrumbs><a
                                href=index.html class=home>Home</a> <span
                        ...
                        <span
                                class=current>Construct an user-friendly website</span></div>
                </div>
            </div>
        </div>
    </div>
...
<main id=main class=site-main>
    ...
    {{--title detai --}}
    <?php
    if(\App\Lib\BHelp::getConfigSetting('CASE_STUDY_DETAIL_12')){
        echo \App\Lib\BHelp::getConfigSetting('CASE_STUDY_DETAIL_12');
    }
    ?>
