            ...
            <div class=page-header_content>
                <div class=page-header_breadcrumbs style="color: #666666; font-size: 15px; line-height: 24px;">
                    <div class=breadcrumbs><a href=index.html class=home>Home</a> <span class=divider></span> <a
                                href=service_ldcc_page.html>Case Study</a>
                        <span id="application" class=divider>

              </span>
                        <span class=current>Linkage solution to State Bank of Vietnam</span>
                    </div>
                </div>
            </div>
        </div>
...
<main id=main class=site-main>
    ...
    {{--title detai 2--}}
    <?php
    if(\App\Lib\BHelp::getConfigSetting('CASE_STUDY_DETAIL_2')){
        echo \App\Lib\BHelp::getConfigSetting('CASE_STUDY_DETAIL_2');
    }
    ?>
            <!--      API gateway (2/2)-->
