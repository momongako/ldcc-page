...
@section('content')
<div id="confirm" class="set-lightbox cat_default wrapper">
	...
	<main>
		...
		<div class="cmn_section">
			<div class="cmn_container">
				...
				<form method="POST" action="{{ route('user.store') }}" id="confirm-form">
                @csrf
                ...
                <button type="submit" name="action" class="cmn_btn_white cmn_btn" value="sent"><span>会員情報の変更</span></button>
            </div>
